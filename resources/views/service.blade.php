 ...
 <div class="corp mt-md-5 pt-md-5" style="background: rgb(245, 246, 246);">
        ...
        <div class="produit bg-white mt-md-5 pt-md-5">
            ...
            <div id="produitCarousel" class="carousel slide" data-bs-ride="carousel">
                ...
                <button class="carousel-control-prev" type="button" data-bs-target="#produitCarousel"
                    data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Previous</span>
                </button>
                <button class="carousel-control-next" type="button" data-bs-target="#produitCarousel"
                    data-bs-slide="next">
