...
<div class="row my-md-5">
    <div class="col-md-11 mx-auto row d-flex justify-content-center dashbord">
        <div class="border-start border-5 border-danger col-md-3 shadow m-3 py-md-3 rounded">
            <h4 class="d-inline  fw-bold"><span class="me-2">{{ $countServ ?? '0' }}</span>{{__("Service")}}</h4><span class="bi-globe me-2 float-end h4"></span>
        </div>
        <div class="border-start border-5 border-danger col-md-3 shadow m-3  py-md-3 rounded">
            <h5 class="d-inline fw-bold"><span class="me-2">{{ $countAgent ?? '0' }}</span>{{__("Employe")}}</h5><span class="bi-person-badge me-2 float-end h4">
        </div>
        <div class="border-start border-5 border-danger col-md-3 shadow py-md-3 rounded m-3">
            <h4 class="d-inline fw-bold"><span class="me-2">{{ $countPhoto ?? '0' }}</span>{{__("Photos")}}</h4><span class="bi-border-start border-5 border-danger-image me-2 h4 float-end">
        </div>
    </div>
    <div class="col-md-11 mx-auto row d-flex justify-content-center dashbord">
        <div class="border-start border-5 border-danger col-md-3 shadow m-3  py-md-3 rounded">
