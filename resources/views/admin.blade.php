...
<div class="row my-md-5">
    <div class="col-md-11 mx-auto row d-flex justify-content-center dashbord">
        ...
        <div class="border-start border-5 border-danger col-md-3 shadow py-md-3 rounded m-3">
            <h4 class="d-inline fw-bold"><span class="me-2">{{ $countPhoto ?? '0' }}</span>{{__("Photos")}}@if ($countPhoto?? 0){{"s"}}
    ...
    <div class="col-md-11 mx-auto row d-flex justify-content-center dashbord">
        <div class="border-start border-5 border-danger col-md-3 shadow m-3  py-md-3 rounded">
            <h5 class="d-inline fw-bold"><span class="me-2">{{ $countProd ?? '0' }}</span>{{__("Produits")}}@if ($countProd?? 0){{"s"}}
        ...
        <div class="border-start border-5 border-danger col-md-3 shadow  py-md-3 rounded m-3">
            <h4 class="d-inlin fw-bold"> <span class="bi-truck me-2"></span>{{__("Commande")}} @if ($countCom?? 0){{"s"}}
